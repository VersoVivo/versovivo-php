...
<body>
    ...
    <!--Botão de ver mais-->
    <div class="button1">
    <button class="dropdown-title" onclick="window.location.href='batalhas.html'" style="border: 2px solid rgb(255, 255, 255); border-radius: 6px; display: flex; align-items: center; width: 110px; margin-left: 63%; height: 40px; background-color: transparent; cursor: pointer;">
   ...
   <!--Fim do botão de ver mais-->
    ...
    <!--Fundo dos Mc's-->
    <div class="banner">
        <img src="imagens/fundo_rapper.jpeg" alt="Banner dos MC's" title="Banner dos MC's" style="width: 140%; margin-left: -40%; height: 800px; filter: brightness(50%);"><p class="mais_eventos" style="margin-top: -600px; margin-left: 60px; filter: brightness(100%);">Principais MC's</p>
    </div>
    ...
    <!--Botão de ver mais-->
    <div class="button2">
    <button class="dropdown-title" onclick="window.location.href='mc.html'" style="border: 2px solid rgb(255, 255, 255); border-radius: 6px; display: flex; align-items: center; width: 110px; margin-left: 75%; height: 40px; background-color: transparent; cursor: pointer; margin-top: 8%;">
